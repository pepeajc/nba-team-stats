...
export default function StandingsPage() {
    ...
    const { navigate } = useRouteStorage();
                                            ...
                                            <a
                                                ...
                                                onClick={() =>
                                                    navigate({
                                                        type: "team",
                                                        id: team.teamId,
                                                        slug: getSlugName("team", team.teamName),
                                                    })
                                                }
                                                className="col-span-6 items-center flex gap-2"
                                            >
    ...
    leagueData.children.forEach((conference: any) => {
        ...
        if (conference.children?.[0]) {
            console.log(
                ...
                JSON.stringify(conference.children[0], null, 2).substring(
                    0,
                    500
                )
            );
        ...
        standingsData.forEach((entry: any) => {
            ...
            const lossesObj = entry.stats?.find(
                (s: any) => s.name === "losses"
            );
            const winPctObj = entry.stats?.find(
                (s: any) => s.name === "winPercent"
            );
